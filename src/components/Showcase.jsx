        ...
        <div className="wrapper">
          <div className="lg:max-w-md">
            ...
            <div className="space-y-5 mt-7 pe-10">
              ...
              <p>
                It drives Apple Intelegence on iPad Pro, so you can write,
                create, and accomplish more with ease. All in a design thats
              ...
              <p className="text-primary">
                Learn more about Apple Intelegence
              </p>
            </div>
          </div>
          <div className="maw-w-3xs space-y-14">
